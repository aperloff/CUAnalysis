...
void DrawPieCharts() { 
    ...
    set_jbradmil_style_lite(hlostlep, "lost_lep");
    set_jbradmil_style_lite(hhadtau, "had_tau");
    set_jbradmil_style_lite(hqcd, "qcd");
    set_jbradmil_style_lite(hznn, "znn");
  //  TLegend * leg1 = new TLegend(0.12, 0.815, 0.9, 0.865);
    TLegend * leg1 = new TLegend(0.12, 0.79, 0.9, 0.84);
    set_jbradmil_style(leg1,0.025);
    leg1->SetNColumns(4);
  ...
  // CMS_lumi(thecanvas, iPeriod, iPos, lumi_sqrtS);
    ...
    thecanvas->Print("Data_BG_Pie_vs_NJets_NBJets.pdf");
    thecanvas->Print("Data_BG_Pie_vs_NJets_NBJets.png");
